...
const features = [
  ...
  'Fast URL redirects with minimal latency',
  'Dashboard to manage all shortened links',
      ...
      <div className="page-card" style={{ maxWidth: 800, margin: '0 auto', background: '#fff', border: '2px solid #1a1a1a', borderRadius: 16, boxShadow: '12px 12px 0px rgba(26,26,26,1)', padding: '56px 24px' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 800, color: '#1a1a1a', fontSize: 44, marginTop: 8 }}>
            URL <span style={{ color: '#FFD400', textShadow: '-1px -1px 0 #1a1a1a, 1px -1px 0 #1a1a1a, -1px 1px 0 #1a1a1a, 1px 1px 0 #1a1a1a' }}>Shortener</span>
          </h1>
          <p style={{ fontSize: 14, color: 'rgba(26,26,26,0.6)', marginTop: 8 }}>A simple and fast URL shortening service.</p>
        </div>
        ...
        <div className="doc-section" style={docSectionStyle}>
          ...
          <p style={pStyle}>URL Shortener is a web service that converts long URLs into compact, shareable short links. It includes analytics to track click counts and supports custom aliases for branding.</p>
        </div>
        ...
        <div className="doc-section" style={docSectionStyle}>
          ...
          <p style={pStyle}>The backend generates short codes and handles redirects, MongoDB stores URL mappings and analytics, and React provides the creation dashboard.</p>
        </div>
        ...
        <div className="doc-section" style={docSectionStyle}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
            <a href="https://url-shortener-rishabh.netlify.app" target="_blank" rel="noopener noreferrer" style={linkBtnStyle}>Live Demo</a>
            <a href="https://github.com/RishabhKothiyal1/url-shortener" target="_blank" rel="noopener noreferrer" style={linkBtnStyle}>GitHub</a>
          </div>
        </div>
