...
export default function TribeChatDocs() {
      ...
      <div className="page-card" style={{ maxWidth: 800, margin: '0 auto', background: '#fff', border: '2px solid #1a1a1a', borderRadius: 16, boxShadow: '12px 12px 0px rgba(26,26,26,1)', padding: '56px 24px' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 800, color: '#1a1a1a', fontSize: 44, marginTop: 8 }}>
            Tribe<span style={{ color: '#FFD400', textShadow: '-1px -1px 0 #1a1a1a, 1px -1px 0 #1a1a1a, -1px 1px 0 #1a1a1a, 1px 1px 0 #1a1a1a' }}>Chat</span>
          </h1>
          <p style={{ fontSize: 14, color: 'rgba(26,26,26,0.6)', marginTop: 8 }}>Real-time group chat application.</p>
        </div>
        ...
        <div className="doc-section" style={docSectionStyle}>
          ...
          <p style={pStyle}>TribeChat is a real-time group messaging platform that enables users to create communities, join conversations, and communicate instantly. Built with Socket.io for real-time bidirectional communication.</p>
        </div>
        ...
        <div className="doc-section" style={docSectionStyle}>
          ...
          <p style={pStyle}>Real-time communication powered by Socket.io. The backend uses Express with MongoDB for persistence, and React provides the interactive chat interface.</p>
        </div>
        ...
        <div className="doc-section" style={docSectionStyle}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
            <a href="https://tribechat.netlify.app" target="_blank" rel="noopener noreferrer" style={linkBtnStyle}>Live Demo →</a>
            <a href="https://github.com/RishabhKothiyal1/tribechat" target="_blank" rel="noopener noreferrer" style={linkBtnStyle}>GitHub →</a>
          </div>
        </div>
